...
- `apply_patch`, a special command for GPT models that reads Codex `*** Begin Patch` / `*** End Patch` syntax from stdin. For non-GPT models, use `edit`, `sed`, `patch`, or other methods instead.
